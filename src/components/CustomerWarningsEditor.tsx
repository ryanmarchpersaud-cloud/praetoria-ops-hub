...
export const WARNING_TYPES = [
  ...
  { value: 'non_payment', label: '🚫 Did Not Pay (Skipped Final Month)', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  { value: 'broken_contract', label: '📄💔 Broke Service Contract Early', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  { value: 'bad_review', label: '⭐ Left Bad Google Review', color: 'bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-400' },
  { value: 'bad_review_other', label: '👎 Bad Review (Facebook / Other)', color: 'bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-400' },
  { value: 'fake_review', label: '🎭 Posted Fake / Misleading Review', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  { value: 'promised_review_no_show', label: '🤥 Promised Review — Never Posted', color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400' },
  { value: 'chargeback', label: '💳⛔ Chargeback / Disputed Payment', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  { value: 'cheque_bounced', label: '📉 Bounced Cheque / NSF', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  { value: 'late_payer', label: '⏰💰 Chronic Late Payer', color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400' },
  { value: 'no_show', label: '👻 No-Show / Cancelled Last Minute', color: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400' },
  { value: 'price_haggler', label: '💸 Excessive Price Haggling', color: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' },
  { value: 'scope_creep', label: '📈 Demands Free Extra Work', color: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400' },
  { value: 'unrealistic_expectations', label: '🎯 Unrealistic Expectations', color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400' },
  { value: 'false_damage_claim', label: '🛠️❌ False Damage Claim', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  { value: 'threatened_legal', label: '⚖️ Threatened Legal Action', color: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  { value: 'do_not_service', label: '🛑 DO NOT SERVICE — Banned', color: 'bg-red-200 text-red-900 dark:bg-red-900/50 dark:text-red-300 font-bold' },
