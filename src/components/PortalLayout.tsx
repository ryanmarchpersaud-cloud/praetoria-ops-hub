...
import { MapPin, FileText, ClipboardCheck, Camera, MessageSquarePlus, User, LogOut, Menu, X, ShieldCheck, Receipt, ChevronRight, Home, Settings2, RefreshCw, Gift, HelpCircle, Snowflake, FolderOpen } from 'lucide-react';
...
const portalNav = [
  ...
  { title: 'My Documents', to: '/portal/documents', icon: FolderOpen, tileColor: 'action-tile-blue', iconColor: 'text-indigo-600' },
