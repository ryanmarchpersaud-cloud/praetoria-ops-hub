...
/* Row 5 — PM Staff Activity: REMOVED.
   Replaced by the shared LiveWorkforcePanel with scope="pm" on PMDashboard.
   See usePMLiveWorkforce in src/hooks/useTimesheets.ts. */
