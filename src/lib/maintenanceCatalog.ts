...
export const MAINTENANCE_CATALOG: MaintenanceCategory[] = [
  ...
  {
    key: 'fire_smoke_alarm', label: 'Fire / Smoke / Alarm Safety', icon: '🚨',
    issues: [
      { label: 'Fire alarm going off', urgent: true, priority: 'urgent' },
      { label: 'Smoke alarm going off', urgent: true, priority: 'urgent' },
      { label: 'Carbon monoxide alarm going off', urgent: true, priority: 'urgent' },
      { label: 'Smoke smell', urgent: true, priority: 'urgent' },
      { label: 'Burning smell', urgent: true, priority: 'urgent' },
      { label: 'Smoke detector chirping', priority: 'normal' },
      { label: 'Smoke detector not working', urgent: true, priority: 'urgent' },
      { label: 'Carbon monoxide detector not working', urgent: true, priority: 'urgent' },
      { label: 'Fire extinguisher concern' },
      { label: 'Fire door concern' },
      { label: 'Emergency exit blocked', urgent: true, priority: 'urgent' },
      { label: 'Other fire/safety concern', priority: 'urgent' },
    ],
  },
  {
    key: 'noise', label: 'Noise / Neighbour Concern', icon: '🔊',
    issues: [
      { label: 'Loud music', nonRepair: true },
      { label: 'Loud party', nonRepair: true },
      { label: 'Tenant making noise', nonRepair: true },
      { label: 'Ongoing noise complaint', nonRepair: true },
      { label: 'Late-night noise', nonRepair: true },
      { label: 'Pet noise', nonRepair: true },
      { label: 'Vehicle noise', nonRepair: true },
      { label: 'Construction/renovation noise', nonRepair: true },
      { label: 'Repeated disturbance', nonRepair: true },
      { label: 'Other noise concern', nonRepair: true },
    ],
  },
  {
    key: 'tenant_safety', label: 'Tenant / Behaviour / Safety Concern', icon: '⚠️',
    issues: [
      { label: 'Tenant fighting', urgent: true, priority: 'urgent', nonRepair: true },
      { label: 'Threatening behaviour', urgent: true, priority: 'urgent', nonRepair: true },
      { label: 'Suspicious activity', priority: 'urgent', nonRepair: true },
      { label: 'Trespassing concern', priority: 'urgent', nonRepair: true },
      { label: 'Unauthorized person in building', priority: 'urgent', nonRepair: true },
      { label: 'Damage caused by tenant/guest', nonRepair: true },
      { label: 'Harassment concern', priority: 'urgent', nonRepair: true },
      { label: 'Unsafe behaviour', priority: 'urgent', nonRepair: true },
      { label: 'Police/emergency concern', urgent: true, priority: 'urgent', nonRepair: true },
      { label: 'Other tenant safety concern', priority: 'urgent', nonRepair: true },
    ],
  },
  {
    key: 'common_area_cleanliness', label: 'Common Area / Building Cleanliness', icon: '🧹',
    issues: [
      { label: 'Hallway dirty' },
      { label: 'Stairwell dirty' },
      { label: 'Lobby/common area dirty' },
      { label: 'Laundry room dirty' },
      { label: 'Garbage area dirty' },
      { label: 'Garbage overflowing' },
      { label: 'Bad smell in hallway/common area' },
      { label: 'Spill in common area' },
      { label: 'Snow/ice at entrance', priority: 'urgent' },
      { label: 'Exterior walkway concern' },
      { label: 'Common area damage' },
      { label: 'Common area light not working' },
      { label: 'Common door not closing/locking', priority: 'urgent' },
      { label: 'Mailbox area issue' },
    ],
  },
  {
    key: 'odour', label: 'Odour / Smell Concern', icon: '👃',
    issues: [
      { label: 'Gas smell', urgent: true, priority: 'urgent' },
      { label: 'Smoke smell', urgent: true, priority: 'urgent' },
      { label: 'Burning smell', urgent: true, priority: 'urgent' },
      { label: 'Chemical smell', urgent: true, priority: 'urgent' },
      { label: 'Sewer smell', priority: 'urgent' },
      { label: 'Garbage smell' },
      { label: 'Mold/mildew smell' },
      { label: 'Unknown bad smell' },
      { label: 'Pet smell' },
      { label: 'Cooking smell concern', nonRepair: true },
      { label: 'Smell coming from vent' },
      { label: 'Smell in hallway/common area' },
    ],
  },
  {
    key: 'parking_access', label: 'Parking / Access / Building Rules', icon: '🅿️',
    issues: [
      { label: 'Parking complaint', nonRepair: true },
      { label: 'Unauthorized vehicle', nonRepair: true },
      { label: 'Driveway blocked', nonRepair: true },
      { label: 'Garage access issue' },
      { label: 'Visitor parking concern', nonRepair: true },
      { label: 'Tenant blocking access', nonRepair: true },
      { label: 'Snow blocking parking/access', priority: 'urgent' },
      { label: 'Gate/access issue' },
      { label: 'Key/fob/access concern' },
      { label: 'Other access concern' },
    ],
  },
  {
    key: 'property_management', label: 'General Property Management Request', icon: '📋',
    issues: [
      { label: 'Question for property manager', nonRepair: true },
      { label: 'Lease question', nonRepair: true },
      { label: 'Rent/balance question', nonRepair: true },
      { label: 'Document request', nonRepair: true },
      { label: 'Notice question', nonRepair: true },
      { label: 'Permission request', nonRepair: true },
      { label: 'Complaint/concern', nonRepair: true },
      { label: 'I am not sure what category to choose', nonRepair: true },
      { label: 'Other property management request', nonRepair: true },
    ],
  },
  {
    ...
    issues: [
      ...
      { label: 'General question', priority: 'low', nonRepair: true },
