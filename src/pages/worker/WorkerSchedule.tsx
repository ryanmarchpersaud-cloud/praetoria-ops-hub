...
const VISIT_SELECT = 'id, visit_number, visit_status, visit_type, service_date, arrival_time, completion_time, service_summary, crew_notes, properties(property_name, address_line_1, city, province, postal_code), customers(first_name, last_name, phone), jobs(assigned_to, service_category, job_title, job_number, service_instructions)';
