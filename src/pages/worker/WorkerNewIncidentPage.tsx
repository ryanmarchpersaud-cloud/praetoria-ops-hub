...
export default function WorkerNewIncidentPage() {
  const { user } = useAuth();
    ...
    return (
      <div className="px-4 pt-12 pb-4 space-y-6 animate-fade-in text-center">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Your incident report has been filed and sent to management.</p>
        </div>
        <Card>
      ...
      <Card>
        <CardContent className="p-4 space-y-3">
          ...
          <div>
            ...
            <Input placeholder="Site address, area, or zone" value={location} onChange={e => setLocation(e.target.value)} />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">Was medical treatment needed?</p>
            </div>
            <Switch checked={medicalAttention} onCheckedChange={setMedicalAttention} />
          </div>
          <div>
            <Label>Reported To</Label>
            <Input placeholder="Supervisor or manager name" value={reportedTo} onChange={e => setReportedTo(e.target.value)} />
          </div>
        </CardContent>
      </Card>
