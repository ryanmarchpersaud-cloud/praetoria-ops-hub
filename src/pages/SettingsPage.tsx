        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Set the <code className="text-xs bg-muted px-1 py-0.5 rounded">x-webhook-secret</code> header with your <code className="text-xs bg-muted px-1 py-0.5 rounded">N8N_WEBHOOK_SECRET</code> secret value, or use a Supabase Bearer token.
            </p>
          </div>
