// Phase 1C.1 — shared copy of the poller's transport/auth primitives so that
// other comms functions can reuse them without cross-function imports.
// Behaviour is identical to comms-imap-poll/core.ts (covered by its tests).
