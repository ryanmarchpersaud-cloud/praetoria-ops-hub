DROP FUNCTION IF EXISTS public.update_customer_portal_profile(text, text, text, text, text, text, text, text);
...
DROP FUNCTION IF EXISTS public.update_subcontractor_portal_profile(text, text, text, text, text, text);

CREATE FUNCTION public.update_subcontractor_portal_profile(
  p_company_name text,
  p_contact_name text,
  p_phone text DEFAULT NULL,
